...
import { Check, CheckCheck, Play, Pause, X, Download, Volume2, PhoneCall, PhoneMissed, PhoneOff } from 'lucide-react';
      ...
      <div className={`flex flex-col ${isMe ? 'items-end' : 'items-start'} mb-3`}>
        ...
        {isCallLog ? (
          ...
          >
            ...
            {isImage && message.mediaUrl && (
              <div className="mb-2 overflow-hidden rounded-xl bg-black/20">
                <img
                  ...
                  onError={(e) => {
                    // Hide image element on load error
            ...
            {/* Text Content (only if not a voice note placeholder) */}
